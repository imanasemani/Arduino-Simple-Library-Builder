...
Public Class Form1
    ...
    Private Sub Button11_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button11.Click
        ...
        If OpenFileDialog1.ShowDialog = Windows.Forms.DialogResult.OK Then
            ...
            txt_exam_name.Text = Replace(OpenFileDialog1.SafeFileName, ".ino", "")
            txt_exam_name.Text = Replace(OpenFileDialog1.SafeFileName, ".pde", "")
            Call full_color_parser(txt_header, Color.Brown)
            Call full_color_parser(txt_source, Color.Brown)
            Call full_color_parser(txt_example, Color.DarkCyan)
        End If
    ...
    Private Sub btn_open_MouseUp(ByVal sender As Object, ByVal e As System.Windows.Forms.MouseEventArgs) Handles btn_open.MouseUp
        On Error Resume Next
        Me.popup_menu2.Show(Me.Location.X + btn_open.Location.X + e.X, Me.Location.Y + btn_open.Location.Y + e.Y)
    End Sub
    ...
    Private Sub btn_new_prop_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_new_prop.Click
        On Error Resume Next
        txt_property.Text = property_temp.Text
    End Sub
    ...
    Private Sub Label12_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Label12.Click
        On Error Resume Next
        Shell("explorer.exe https://github.com/imanasemani/Arduino-Simple-Library-Builder", vbNormalFocus)
    End Sub
    ...
    Private Sub opt_header_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles opt_header.CheckedChanged

    End Sub

    Private Sub opt_header_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles opt_header.Click
        On Error Resume Next
        TabControl1.SelectTab(0)
        startingPoint = -1
    End Sub

    Private Sub opt_source_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles opt_source.CheckedChanged

    End Sub

    Private Sub opt_source_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles opt_source.Click
        On Error Resume Next
        TabControl1.SelectTab(1)
        startingPoint = -1
    End Sub

    Private Sub opt_keyword_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles opt_keyword.CheckedChanged
        On Error Resume Next
        TabControl1.SelectTab(2)
        startingPoint = -1
    End Sub

    Private Sub opt_example_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles opt_example.CheckedChanged
        On Error Resume Next
        TabControl1.SelectTab(3)
        startingPoint = -1
    End Sub

    Private Sub opt_library_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles opt_library.CheckedChanged
        On Error Resume Next
        TabControl1.SelectTab(4)
        startingPoint = -1
    End Sub

    Private Sub opt_extra_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles opt_extra.CheckedChanged
        On Error Resume Next
        TabControl1.SelectTab(5)
        startingPoint = -1
    End Sub

    Private Sub opt_document_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles opt_document.CheckedChanged
        On Error Resume Next
        TabControl1.SelectTab(6)
        startingPoint = -1
    End Sub

    Private Sub btn_find_next_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_find_next.Click
        On Error Resume Next
        If opt_header.Checked = True Then
            Find_It(txt_header, txt_find.Text)
        ElseIf opt_source.Checked = True Then
            Find_It(txt_source, txt_find.Text)
        ElseIf opt_keyword.Checked = True Then
            Find_It(txt_keywords, txt_find.Text)
        ElseIf opt_library.Checked = True Then
            Find_It(txt_property, txt_find.Text)
        ElseIf opt_example.Checked = True Then
            Find_It(txt_example, txt_find.Text)
        ElseIf opt_extra.Checked = True Then
            Find_It(txt_custom, txt_find.Text)
        ElseIf opt_document.Checked = True Then
            Find_It(txtText, txt_find.Text)
        Else
            MsgBox("Please select an item first!", MsgBoxStyle.Exclamation + MsgBoxStyle.OkOnly, "error")
        End If
       
    End Sub

    Private Sub Find_It(ByVal Box As RichTextBox, ByVal Srch As String)
        On Error Resume Next

        startingPoint = Box.Find(Srch, startingPoint + 1, RichTextBoxFinds.None)
        If (startingPoint >= 0) Then
            Box.SelectionStart = startingPoint
            Box.SelectionLength = Srch.Length
            Box.Focus()
        End If
    End Sub

    Private Sub replace_all(ByVal Box As RichTextBox)
        On Error Resume Next
        Box.Text = Replace(Box.Text, txt_find.Text, txt_replace.Text)
    End Sub

    Private Sub btn_replace_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_replace.Click
        On Error Resume Next
        If opt_header.Checked = True Then
            replace_all(txt_header)
        ElseIf opt_source.Checked = True Then
            replace_all(txt_source)
        ElseIf opt_keyword.Checked = True Then
            replace_all(txt_keywords)
        ElseIf opt_library.Checked = True Then
            replace_all(txt_property)
        ElseIf opt_example.Checked = True Then
            replace_all(txt_example)
        ElseIf opt_extra.Checked = True Then
            replace_all(txt_custom)
        ElseIf opt_document.Checked = True Then
            replace_all(txtText)
        Else
            MsgBox("Please select an item first!", MsgBoxStyle.Exclamation + MsgBoxStyle.OkOnly, "error")
